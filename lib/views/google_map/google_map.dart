...
class _ScreenOneState extends State<ScreenOne> {
  ...
  void fetchNearbyDoctorsClinics(LatLng userLocation) {
    ...
    nearbyMarkers.addAll([
      Marker(
        markerId: const MarkerId('Doctor1'),
        position: LatLng(
            userLocation.latitude + 0.001, userLocation.longitude + 0.001),
        infoWindow: const InfoWindow(title: 'Doctor 1'),
      ),
      Marker(
        markerId: const MarkerId('Doctor2'),
        position: LatLng(
            userLocation.latitude - 0.001, userLocation.longitude - 0.001),
        infoWindow: const InfoWindow(title: 'Doctor 2'),
      ),
    ]);
  }
